...
//			ObjectPrx base1 = communicator.stringToProxy("calc/calc11:tcp -h 127.0.0.2 -p 10000 : udp -h 127.0.0.2 -p 10000"); //opcja -z włącza możliwość kompresji wiadomości
